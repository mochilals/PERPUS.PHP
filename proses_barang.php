...
if($_POST){
    ...
    if(empty($nama_siswa)){
        ...
        include "connect.php";
        $insert=mysqli_query($conn,"insert into siswa (nama_barang,tanggal_lahir, gender, alamat, username, password, id_kelas) value ('".$nama_siswa."','".$tanggal_lahir."','".$gender."','".$alamat."','".$username."','".md5($password)."','".$id_kelas."')") or die(mysqli_error($conn));
        if($insert){
